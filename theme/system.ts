...
export const THEME_SURFACES = {
  ...
  statusBadge: 'text-xs font-extrabold uppercase tracking-wider bg-slate-100 text-slate-600 px-2 py-0.5 rounded-md border border-slate-200',
  ...
  sectionSubtitle: 'text-xs font-semibold text-slate-400',
  subHeading: 'px-3 py-0.5 text-xs font-extrabold text-slate-400 uppercase tracking-wider',
